...
| P05 | 상품     | 비회원 ACTIVE/숨김 미노출      | route 검토              | 공개 ACTIVE만           | 구현                      | PASS                | routes.products           |
...
| W03 | 송금     | transaction rollback/음수 방지 | 동시 통합/DB checks     | 1 성공, balance>=0      | 통과                      | api.test, migration |
| W04 | 송금     | idempotency                    | 같은 key 반복           | 같은 transfer, 1회 차감 | 통과                      | api.test            |
...
| M01 | 관리자   | 일반 사용자 UI/API 차단        | 통합+E2E                | 403                     | 통과                      | api.test, E2E       |
...
| G05 | 공통     | lock/audit                     | npm                     | lock/0 vuln             | 0                         | PASS                | package-lock, npm audit   |
...
| Q02 | 품질     | 통합/UI test                   | npm test                | 12 pass                 | 12 pass                   | PASS                | TEST_REPORT               |
